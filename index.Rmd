...
```{r}
barplot(height=ca_covid19.confirmados$confirmados,names.arg=ca_covid19.confirmados$pais,xlab="País",ylab="Millones de habitantes",main="Personas confirmadas de los países centroamericanos y República Dominicana")
...
barplot(height=ca_covid19.activos$activos,names.arg=ca_covid19.activos$pais,xlab="País",ylab="Millones de habitantes",main="Personas activas de los países centroamericanos y República Dominicana")
...
barplot(height=ca_covid19.fallecidos$fallecidos,names.arg=ca_covid19.fallecidos$pais,xlab="País",ylab="Millones de habitantes",main="Personas fallecidas de los países centroamericanos y República Dominicana")
